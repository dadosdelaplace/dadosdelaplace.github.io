...
Me presento: **Javi(er) Álvarez Liébana** ([<mark><b>@dadosdelaplace</b></mark>](https://twitter.com/dadosdelaplace)), nacido en Carabanchel (Madrid) en 1989, matemático y **doctor en Estadística** (Universidad de Granada), y actualmente trabajo como **investigador y docente (ayudante doctor)** en la **Universidad Complutense** (Madrid). Mis campos de investigación son la **ciencia de datos**{:.bg-dark .text-light}, **Functional Data Analysis**{:.bg-dark .text-light}, **series temporales**{:.bg-dark .text-light}. Imparto además **cursos** de **análisis y visualización de datos en R**{:.bg-dark .text-light}. Puedes encontrar parte de mi investigación en [<mark><b>Google Scholar</b></mark>](https://scholar.google.es/citations?user=Wb3lxFIAAAAJ&hl=es).
  </div>
</div>
...
* **Invited Conference**{:.bg-secondary .text-light} Title: A goodness-of-fit test for functional time series with applications to diffusion processes. Congress: New Bridges between Mathematics and Data Science (NBMDS, Valladolid, Spain) **2021**{:.bg-dark .text-light}. Authors: J. Álvarez-Liébana, A. López Perez, W. González-Manteiga and M. Febrero-Bande.
* **Invited Conference**{:.bg-secondary .text-light} Title: A goodness-of-fit test for the functional linear model with functional responses. Congress: 5th International Symposium on Nonparametric Statistics (ISNPS, Paphos, Cyprus) **2020**{:.bg-dark .text-light}. Authors: J. Álvarez-Liébana, E. García-Portugués, G. Álvarez-Pérez and W. González-Manteiga.
* **Invited Conference**{:.bg-secondary .text-light} Title: On the inference of functional time series. Congress: 1st Regional Workshop of European young researchers in statistics (Paris, France) **2018**{:.bg-dark .text-light}. Authors: J. Álvarez-Liébana.     
* **Invited Conference**{:.bg-secondary .text-light} Title: Estimación fuertemente consistente de procesos autorregresivos, con variables exógenas, en espacios de Banach abstractos. Congress: XXXVII Congreso Nacional de Estadística e Investigación Operativa (SEIO18, Oviedo, Spain) **2018**{:.bg-dark .text-light}. Authors: J. Álvarez-Liébana and M. D. Ruiz-Medina.
* **Invited Conference**{:.bg-secondary .text-light} Title: Strongly-consistent prediction of air pollutants PM10 by high-singular ARBX(1) processes. Congress: 2018 CRoNoS Summer Course and Workshop on Functional Data Analysis (COMPSTAT - CRONOS FDA 18, Iasi, Rumania) **2018**{:.bg-dark .text-light}. Authors: J. Álvarez-Liébana and M. D. Ruiz-Medina.
* **Invited Conference**{:.bg-secondary .text-light} Title: Strong consistency results for the estimation and prediction of ARH(1) processes. Congress: Congreso Bienal de la Real Sociedad Matemática Española (RSME17, Zaragoza, Spain) **2017**{:.bg-dark .text-light}. Authors: J. Álvarez-Liébana and M. D. Ruiz-Medina.

* **Organizing Committee**{:.bg-secondary .text-light} of «III International Workshop on Advances in Functional Data Analysis». May 23th-24th, **2019**{:.bg-dark .text-light} – University of Cantabria (Castro Urdiales, Spain).  
* **Organizing Committee**{:.bg-secondary .text-light} of «1st Spanish Young Statisticians and Operational Researchers Meeting». November 13th-15th, **2017**{:.bg-dark .text-light} – IEMATH-GR (Granada, Spain). 
