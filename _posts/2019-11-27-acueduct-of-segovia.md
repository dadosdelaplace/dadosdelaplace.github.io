---
header_type: "hero"
header_img : "https://cdn.pixabay.com/photo/2018/04/16/15/52/chess-3325010_960_720.jpg"
title: "R, Python o Matlab: la batalla final
subtitle: "¿Qué lenguaje elegir para el análisis de datos?"
last_modified_at: 2021-12-16
tags: [R, python, programación]
...
* Fue diseñado especialmente para el análisis de datos, por lo que se requieren **pocas líneas de código** para la implementación de flujos de trabajo en la carga de datos, preprocesamiento, modelos predictivos y validación.
...
Busca siempre lenguajes de software libre y que tengan ya una amplia comunidad de usuarios
